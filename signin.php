...
class SignInSheet {
	//Total number of entries in Sign-In Sheet this number is updated everytime new entry is added or deleted
		var $total=0;
		var $entry_id=0;
		var $entry_author='';
		var $entry_email='';
		...
		var $entry_hidden='0'; 
			/* this variable is used to hide, unhide a specific entry by default the entry is viewable to everybody */
        ...
        /* This function can be used to display all the entries in the sign-in sheet or can be called with proper $start and $end values to eturn only specific no. of entries. when called with $start =-1 & $end =-1 will display all the entries on a single page */
